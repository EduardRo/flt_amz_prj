import 'package:flt_amz_prj/finApp/transaction_model.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<TransactionModel> _transactionList = [
    TransactionModel(
      logo: 'assets/finapp/mcdonalds.png',
      name: "McDonald\'s",
      date: '22.02.2020',
      amount: '-22,50',
    ),
    TransactionModel(
      logo: 'assets/finapp/gas-station.png',
      name: "Petrol",
      date: '22.02.2020',
      amount: '-75,45',
    ),
  ...
  Column _reportInnerCell(
      {bool isSavings = true, String title = 'title', String value = '33'}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Text(
